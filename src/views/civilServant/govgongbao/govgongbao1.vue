...
export default {
  ...
  data() {
    return {
      createTime: '2019-02-28 09:09:00',
      text: `设立河北雄安新区，是以习近平同志为核心的党中央深入推进京津冀协同发展作出的一项重大决策部署，是继深圳经济特区和上海浦东新区之后又一具有全国意义的新区，是重大的历史性战略选择，是千年大计、国家大事。为支持雄安新区全面深化改革和扩大开放，提出以下意见。

一、总体要求<div class="err">学习</div>
